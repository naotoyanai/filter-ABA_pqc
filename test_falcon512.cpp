...
static OQS_STATUS example_stack(void) {
    ...
    */
	...
	if (rc != OQS_SUCCESS) {
		fprintf(stderr, "ERROR: OQS_SIG_falcon_512_keypair failed!\n");
		cleanup_stack(secret_key, OQS_SIG_falcon_512_length_secret_key);
		return OQS_ERROR;
	}
    ...
    */
	...
	printf("[example_stack] OQS_SIG_falcon_512 was not enabled at compile-time.\n");
	return OQS_SUCCESS;
...
void test_vf_no_padding_falcon() { /* Vacuum with falcon */

    /*
        We implemented VF with Falcon.
    ...
    */
    ...
    /* Setup: Generation of Falcon keys */
